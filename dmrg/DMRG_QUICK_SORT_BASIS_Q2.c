...
void DMRG_QUICK_SORT_BASIS_Q2(short *Array_1, short *Array_2, short *Array_3, short *Array_4, short *Array_5, short *Array_6, int left, int right) {
   ...
   for (j = left; j < right - 1; j++) {
      ...
      c6 = (Array_6[j] < pivot_6);
      c5 = e6 && (Array_5[j] < pivot_5);
      c4 = e6 && e5 && (Array_4[j] < pivot_4);
      c3 = e6 && e5 && e4 && (Array_3[j] < pivot_3);
      c2 = e6 && e5 && e4 && e3 && (Array_2[j] < pivot_2);
      c1 = e6 && e5 && e4 && e3 && e2 && (Array_1[j] < pivot_1);
   ...
   DMRG_QUICK_SORT_BASIS_Q2(Array_1, Array_2, Array_3, Array_4, Array_5, Array_6, left, i    );
   DMRG_QUICK_SORT_BASIS_Q2(Array_1, Array_2, Array_3, Array_4, Array_5, Array_6, i+1 , right);
