...
void QUICK_SORT_STABLE_INT2_SINT4(int *Base, int *Target, int *A_Int, short *A1, short *A2, short *A3, short *A4, int left, int right) {
   ...
   SWAP_INT(&A_Int[pivot_index] , &A_Int[right - 1] );
   ...
   SWAP_INT(&A_Int[i] , &A_Int[right - 1] );
   SWAP_SINT(&A1[i]   , &A1[right - 1]    );
   SWAP_SINT(&A2[i]   , &A2[right - 1]    );
   SWAP_SINT(&A3[i]   , &A3[right - 1]    );
   SWAP_SINT(&A4[i]   , &A4[right - 1]    );
   
   QUICK_SORT_STABLE_INT2_SINT4(Base, Target, A_Int, A1, A2, A3, A4, left, i    );
   QUICK_SORT_STABLE_INT2_SINT4(Base, Target, A_Int, A1, A2, A3, A4, i+1 , right);
