...
void RENORMALIZE(BLOCK *System, BLOCK *Enviro, MODEL_1DKLM_TVF *Model, DMRG_PARAMETER *Dmrg_Param, DMRG_STATUS *Dmrg_Status, DMRG_TIME *Dmrg_Time) {
   ...
   DMRG_SYSTEM_INFO *Dmrg_System = DMRG_GET_SYSTEM_INFO_Q2(Dmrg_Basis->Tot_Ele_LLLR, Dmrg_Basis->Tot_Parity_LLLR, Dmrg_Basis, Dmrg_Status->GS_Vec, Dmrg_Param->max_dim_system, Model->p_threads, Dmrg_Time);
   
   OUTPUT_T_ERROR(Dmrg_System, Dmrg_Status, Model);
   
   TRANSFORM_MATRIX(System, Dmrg_Basis, Dmrg_System, Dmrg_Status, Model, Dmrg_Time);
