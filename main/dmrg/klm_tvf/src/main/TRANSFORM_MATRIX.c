...
void TRANSFORM_MATRIX(BLOCK *Block_System, DMRG_BASIS *Dmrg_Basis, DMRG_SYSTEM_INFO *Dmrg_System, DMRG_STATUS *Dmrg_Status, MODEL_1DKLM_TVF *Model, DMRG_TIME *Dmrg_Time) {
   ...
   int elem_num = dim_LLLR*dim_LLLR;
   ...
   CRS1 *Ham_LLLR = GET_HAM_LLLR(Block_System, Dmrg_Basis, Dmrg_System, Dmrg_Status, Model);
   ...
   DMRG_EXTEND_AND_REDUCE(NULL, Block_System->Even_On  , Block_System->Even_RE[LL_site + 1]  , Block_System->Tot_Ele[LL_site], "LR", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
   DMRG_EXTEND_AND_REDUCE(NULL, Block_System->Even_D_On, Block_System->Even_D_RE[LL_site + 1], Block_System->Tot_Ele[LL_site], "LR", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
   DMRG_EXTEND_AND_REDUCE(NULL, Block_System->Odd_On   , Block_System->Odd_RE[LL_site + 1]   , Block_System->Tot_Ele[LL_site], "LR", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
   DMRG_EXTEND_AND_REDUCE(NULL, Block_System->Odd_D_On , Block_System->Odd_D_RE[LL_site + 1] , Block_System->Tot_Ele[LL_site], "LR", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
   ...
   if (strcmp(Model->BC, "PBC_LL_LR_RR_RL") == 0 || strcmp(Model->BC, "PBC_LL_LR_RL_RR") == 0) {
      DMRG_EXTEND_AND_REDUCE(Block_System->Even_LE[LL_site]  , NULL, Block_System->Even_LE[LL_site + 1]  , Block_System->Tot_Ele[LL_site], "LL", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
      DMRG_EXTEND_AND_REDUCE(Block_System->Even_D_LE[LL_site], NULL, Block_System->Even_D_LE[LL_site + 1], Block_System->Tot_Ele[LL_site], "LL", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
      DMRG_EXTEND_AND_REDUCE(Block_System->Odd_LE[LL_site]   , NULL, Block_System->Odd_LE[LL_site + 1]   , Block_System->Tot_Ele[LL_site], "LL", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
      DMRG_EXTEND_AND_REDUCE(Block_System->Odd_D_LE[LL_site] , NULL, Block_System->Odd_D_LE[LL_site + 1] , Block_System->Tot_Ele[LL_site], "LL", "Yes", T_M, T_MD, M_CRS, M_CCS, V, Dmrg_Basis_LLLR);
   ...
   for (basis = 0; basis < Dmrg_System->dim_renorm; basis++) {
      ...
      Block_System->Tot_Parity[LL_site + 1][basis] = Dmrg_System->Q_Number2[basis];
   }
