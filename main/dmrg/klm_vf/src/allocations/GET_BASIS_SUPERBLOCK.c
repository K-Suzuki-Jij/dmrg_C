...
#pragma omp critical
                  {
                     ...
                     Tot_Sz_LLLR_LLLRRRRL[dim_LLLRRRRL]  = System->Tot_Sz[LL_site][LL] + ONSITE_FIND_SITE_SZ_SZBASIS_KLM(LR, spin);
                     Tot_Ele_LLLR_LLLRRRRL[dim_LLLRRRRL] = System->Tot_Ele[LL_site][LL] + ONSITE_FIND_SITE_ELE_SZBASIS_KLM(LR, spin);
                     dim_LLLRRRRL++;
                  }
               }
            }
