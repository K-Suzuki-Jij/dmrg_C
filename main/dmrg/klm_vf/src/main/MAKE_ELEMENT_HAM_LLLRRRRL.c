...
void MAKE_ELEMENT_HAM_LLLRRRRL(DMRG_BASIS_ONSITE *Basis_Onsite, DMRG_A_BASIS *A_Basis, int *Inv, HAM_BOX *Box) {
   ...
   //Interaction LLLR
   DMRG_MAKE_ELEM_LLLR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_D_RE_System  , Box->CUp_On    , Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LL_LR", "Yes");
   DMRG_MAKE_ELEM_LLLR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_RE_System    , Box->CUp_D_On  , Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LR_LL", "Yes");
   DMRG_MAKE_ELEM_LLLR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_D_RE_System, Box->CDown_On  , Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LL_LR", "Yes");
   DMRG_MAKE_ELEM_LLLR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_RE_System  , Box->CDown_D_On, Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LR_LL", "Yes");
   ...
   //Interaction RRRL
   DMRG_MAKE_ELEM_RRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_D_RE_Enviro  , Box->CUp_On    , Box->t*Box->SSD_RRRL       , Box->Ele_RR, &elem_num, "RR_RL", "Yes");
   DMRG_MAKE_ELEM_RRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_RE_Enviro    , Box->CUp_D_On  , Box->t*Box->SSD_RRRL       , Box->Ele_RR, &elem_num, "RL_RR", "Yes");
   DMRG_MAKE_ELEM_RRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_D_RE_Enviro, Box->CDown_On  , Box->t*Box->SSD_RRRL       , Box->Ele_RR, &elem_num, "RR_RL", "Yes");
   DMRG_MAKE_ELEM_RRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_RE_Enviro  , Box->CDown_D_On, Box->t*Box->SSD_RRRL       , Box->Ele_RR, &elem_num, "RL_RR", "Yes");
   ...
   if (strcmp(Box->BC, "OBC") == 0 || strcmp(Box->BC, "SSD") == 0 || strcmp(Box->BC, "PBC_LL_LR_RL_RR") == 0) {
      //Interaction LRRL
      DMRG_MAKE_ELEM_LRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_D_On  , Box->CUp_On    , Box->t*Box->SSD_LRRL       , Box->Ele_RR, Box->Ele_On, &elem_num, "LR_RL", "Yes");
      DMRG_MAKE_ELEM_LRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_On    , Box->CUp_D_On  , Box->t*Box->SSD_LRRL       , Box->Ele_RR, Box->Ele_On, &elem_num, "RL_LR", "Yes");
      DMRG_MAKE_ELEM_LRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_D_On, Box->CDown_On  , Box->t*Box->SSD_LRRL       , Box->Ele_RR, Box->Ele_On, &elem_num, "LR_RL", "Yes");
      DMRG_MAKE_ELEM_LRRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_On  , Box->CDown_D_On, Box->t*Box->SSD_LRRL       , Box->Ele_RR, Box->Ele_On, &elem_num, "RL_LR", "Yes");
   ...
   if ( strcmp(Box->BC, "PBC_LL_LR_RL_RR") == 0) {
      //Interaction LLRR
      DMRG_MAKE_ELEM_LLRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_D_LE_System  , Box->CUp_LE_Enviro    , Box->t       , Box->Ele_LL, Box->Ele_On, &elem_num, "LL_RR", "Yes");
      DMRG_MAKE_ELEM_LLRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_LE_System    , Box->CUp_D_LE_Enviro  , Box->t       , Box->Ele_LL, Box->Ele_On, &elem_num, "RR_LL", "Yes");
      DMRG_MAKE_ELEM_LLRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_D_LE_System, Box->CDown_LE_Enviro  , Box->t       , Box->Ele_LL, Box->Ele_On, &elem_num, "LL_RR", "Yes");
      DMRG_MAKE_ELEM_LLRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_LE_System  , Box->CDown_D_LE_Enviro, Box->t       , Box->Ele_LL, Box->Ele_On, &elem_num, "RR_LL", "Yes");
   ...
   if (strcmp(Box->BC, "PBC_LL_LR_RR_RL") == 0) {
      //Interaction LRRR
      DMRG_MAKE_ELEM_LRRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_D_On  , Box->CUp_LE_Enviro    , Box->t       , Box->Ele_On, &elem_num, "LR_RR", "Yes");
      DMRG_MAKE_ELEM_LRRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_On    , Box->CUp_D_LE_Enviro  , Box->t       , Box->Ele_On, &elem_num, "RR_LR", "Yes");
      DMRG_MAKE_ELEM_LRRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_D_On, Box->CDown_LE_Enviro  , Box->t       , Box->Ele_On, &elem_num, "LR_RR", "Yes");
      DMRG_MAKE_ELEM_LRRR_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_On  , Box->CDown_D_LE_Enviro, Box->t       , Box->Ele_On, &elem_num, "RR_LR", "Yes");
      ...
      //Interaction LLRL
      DMRG_MAKE_ELEM_LLRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_D_LE_System  , Box->CUp_On    , Box->t       , Box->Ele_LL, Box->Ele_RR, Box->Ele_On, &elem_num, "LL_RL", "Yes");
      DMRG_MAKE_ELEM_LLRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CUp_LE_System    , Box->CUp_D_On  , Box->t       , Box->Ele_LL, Box->Ele_RR, Box->Ele_On, &elem_num, "RL_LL", "Yes");
      DMRG_MAKE_ELEM_LLRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_D_LE_System, Box->CDown_On  , Box->t       , Box->Ele_LL, Box->Ele_RR, Box->Ele_On, &elem_num, "LL_RL", "Yes");
      DMRG_MAKE_ELEM_LLRL_LLLRRRRL(Basis_Onsite, A_Basis, Inv, Box->CDown_LE_System  , Box->CDown_D_On, Box->t       , Box->Ele_LL, Box->Ele_RR, Box->Ele_On, &elem_num, "RL_LL", "Yes");
