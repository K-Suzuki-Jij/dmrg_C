...
void MAKE_ELEMENT_HAM_LLLR(DMRG_BASIS_ONSITE *Basis_Onsite, DMRG_A_BASIS *A_Basis, int **Inv, HAM_BOX *Box) {
   ...
   //Interaction LLLR
   DMRG_MAKE_ELEM_LLLR_LLLR(Basis_Onsite, A_Basis, Inv, Box->CUp_D_RE_System  , Box->CUp_On    , Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LL_LR", "Yes");
   DMRG_MAKE_ELEM_LLLR_LLLR(Basis_Onsite, A_Basis, Inv, Box->CUp_RE_System    , Box->CUp_D_On  , Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LR_LL", "Yes");
   DMRG_MAKE_ELEM_LLLR_LLLR(Basis_Onsite, A_Basis, Inv, Box->CDown_D_RE_System, Box->CDown_On  , Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LL_LR", "Yes");
   DMRG_MAKE_ELEM_LLLR_LLLR(Basis_Onsite, A_Basis, Inv, Box->CDown_RE_System  , Box->CDown_D_On, Box->t*Box->SSD_LLLR       , Box->Ele_LL, &elem_num, "LR_LL", "Yes");
